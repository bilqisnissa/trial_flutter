      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(child: Image.asset('assets/img/ilustration.png')),
            SizedBox(
              height: 16,
            ),
            Text(
              ...
              children: <Widget>[
                ElevatedButton(
                  style: ElevatedButton.styleFrom(primary: Colors.white),
                    onPressed: (){},
                    child: Image.network('https://pngimg.com/uploads/google/google_PNG19644.png',
                      width: 55,)
                ),
                SizedBox(
                  width: 16,
                ...
                ElevatedButton(
                    style: ElevatedButton.styleFrom(primary: Colors.white),
                    onPressed: (){},
                    child: Image.network('https://pngimg.com/uploads/facebook_logos/facebook_logos_PNG19749.png',
                      width: 55,)
                ),
              ],
            )
